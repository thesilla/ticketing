    ...
    <div id="createUserContainer" class="jumbotron">
        ...
        <form class="form-horizontal" action="adminController.php" method="post" id="createNewUserForm">
            ...
            <div class="panel-body">
                   ...
                   <?php if($createUserErrors['firstname'][1]==1){ echo $createUserErrors['firstname'][0];} ?>
                                    
                   <label  for="lastname">Enter Last Name</label>

                    <input name = "lastname" class="form-control" id="EnterLastName" type="text" placeholder="Last Name">
                    <?php if($createUserErrors['lastname'][1]==1){ echo $createUserErrors['lastname'][0];} ?>
                
                    <label  for="email">Enter Email</label>

                    <input name = "email" class="form-control" id="inputEmail" type="email" placeholder="Email">
                    <?php if($createUserErrors['email'][1]==1){ echo $createUserErrors['email'][0];} ?>
                    ...
                    <?php if($createUserErrors['username'][1]==1){ echo $createUserErrors['username'][0];} ?>
                    ...
                    <?php if($createUserErrors['position'][1]==1){ echo $createUserErrors['position'][0];} ?>
                    
                    
                    <label  for="password1">Enter Password</label>

                    <input name = "password1" class="form-control" id="inputPassword1" type="password" placeholder="Password">
                    <?php if($createUserErrors['password'][1]==1){ echo $createUserErrors['password'][0];} ?>
